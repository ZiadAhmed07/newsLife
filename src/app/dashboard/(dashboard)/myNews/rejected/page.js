...
export default function page() {
    ...
    function getData() {
        if (adminData) {
            axios({
                url: `${apiData}/admin/edit/adminProfile/with/rejected/news/${adminData.admin.id}?page=${countPage}`,
                method: 'get',
                headers: {
        ...
        <div className="w-full overflow-auto">
            <div className="p-2 px-4  border flex justify-between bg-white border-r-8 border-r-red-700">
                ...
                <div className=" flex text-sm text-gray-600 gap-4 items-center">
                    ...
                    <Link href={'/dashboard/myNews/rejected'} className="bg-red-700 rounded-md p-1 text-white"> المرفوضه</Link>
