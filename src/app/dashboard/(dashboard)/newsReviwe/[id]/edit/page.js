                ...
                <form onSubmit={postData} className="bg-white  p-6 flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" required value={data.description} onChange={(e) => { setData(p => ({ ...p, description: e.target.value })) }} placeholder="ادخل وصف المقال  " className="w-full h-10 text-sm rounded-lg p-2 border-gray-200 border focus:border-[2px] outline-none" />
                        </div>
                        <div>
