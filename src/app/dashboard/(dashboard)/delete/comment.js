...
export default function Comment() {
    ...
    function getData() {
        if (adminData) {
            axios({
                url: `${apiData}/admin/showDeleted/comment`,
                method: 'get',
                headers: {
            ...
            return (
                <div className="w-full h-[300px] bg-white border min-w-[500px]">
                    ...
                    <p className="text-center">id</p>
                        ...
                        <p className="text-center">المستخدم</p>
    ...
    function deleteData(id){
        setLoader(true)
        axios({
            url: `${apiData}/admin/forceDelete/comment/${id}`,
            method: 'delete',
            headers: {
                'Authorization': `Bearer ${adminData.access_token}`
            }
    ...
    function restData(id){
        setLoader(true)
        axios({
            url: `${apiData}/admin/restore/comment/${id}`,
            method: 'get',
            headers: {
                'Authorization': `Bearer ${adminData.access_token}`
            }
    ...
    return (
        <div className="w-full overflow-auto">
            ...
            <div className="p-2 px-4 border flex justify-between bg-white border-r-8 border-r-red-700 items-center">
                <p className="font-bold">التعليقات</p>
            </div>
            {FunSetData()}
        </div>
    )
