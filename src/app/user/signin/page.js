                ...
                <form onSubmit={postData} className="w-[400px] flex flex-col gap-6 max-sm:w-[340px]">
                    ...
                    <div>
                        <div className="flex justify-between items-center">
                            ...
                            <Link href={"/user/sendEmail"} className="text-blue-500 text-sm">نسيت كلمه المرور</Link>
                        </div>
                    ...
                    <div className="text-center text-sm text-blue-500">
                        <Link href={'/user/signup'}>ليس لدي حساب! انشاء حساب</Link>
                    </div>
                </form>
            </div>
        </div>
